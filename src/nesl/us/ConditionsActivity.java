...
public class ConditionsActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setTitle("[" + triggerName + ":" + triggerValue + "] Rule " + ruleNum + " Conditions");
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
	  ...
	  inflater.inflate(R.menu.conditions_context_menu, menu);
	}
	...
	public boolean onContextItemSelected(MenuItem item) {
	  ...
	  case R.id.remove_condition:
	    String conditionName = (String)getListView().getAdapter().getItem(info.position);
	    String triggerName = getIntent().getStringExtra("triggerName");	    
	    String triggerValue = getIntent().getStringExtra("triggerValue");	
	    int ruleNum = getIntent().getIntExtra("ruleNum", -1);
	    CoreService.rules.removeCondition(new Event(triggerName, triggerValue), conditionName, ruleNum);
	...
	private void display()
	{
		...
		setListAdapter(new ArrayAdapter<String>(this, R.layout.rule, conditions.toArray(new String[0])));
	}
	
	@Override
	public boolean onCreateOptionsMenu(Menu menu) {
	    MenuInflater inflater = getMenuInflater();
	    inflater.inflate(R.menu.conditions_menu, menu);
	    return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    ...
	    case R.id.add_condition:
		    ...
		    String triggerValue = getIntent().getStringExtra("triggerValue");	  
		    int ruleNum = getIntent().getIntExtra("ruleNum", -1);
			Intent i = new Intent(getApplicationContext(),AddConditionActivity.class);
